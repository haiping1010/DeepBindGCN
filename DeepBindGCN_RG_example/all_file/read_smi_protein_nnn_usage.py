...
compound_dic=np.load('actives_nM_combined_dict.npy', allow_pickle='TRUE').item()
...
frr=open('actives_nM_combined.ism','r')
...
for name in arr_frr:
     arr_tem=name.split(" ")
     arr_name.append(arr_tem[1])

smile_graph[pdbname]=pdb_graph(pdbname)
...
class TestbedDataset(InMemoryDataset):
    ...
    def process(self, xd, pocket_graph, y, smile_graph):
        ...
        for i in range(data_len):
            ...
            c_size1, features1, edge_index1 =  smile_graph[pdbname]
...
train_data = TestbedDataset(root='data1', dataset='L_P_train', xd=arr_name, pocket_graph=pocket_graph, y=train_Y, smile_graph=smile_graph)
